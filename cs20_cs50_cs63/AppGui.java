...
import eg.edu.alexu.csd.datastructure.queue.cs20_cs50_cs63.LinkedBasedQueue;
...
public class AppGui {
	...
	private void initialize() {
		...
		Menu.setLayout(null);
		Menu.add(btnCompose);
		final JButton btnMoveEmail_1 = new JButton("Move Emails");
		...
		btnMoveEmail_1.setFont(new Font("Berlin Sans FB", Font.PLAIN, 15));
		Menu.add(btnMoveEmail_1);
		final JButton btnDeleteEmail = new JButton("Delete Emails");
		...
		final JPanel panelDraft = new JPanel();
		panelDraft.setBounds(315, 11, 759, 637);
		desktopPane.add(panelDraft);
		...
		panelProfile.setBounds(315, 11, 759, 637);
		desktopPane.add(panelProfile);
		...
		panelProfile.add(textFieldProfile);
		...
		panelProfile.add(passwordFieldProfile);
		...
		panelProfile.add(btnSaveProfile);
		...
		panelProfile.add(btnBackProfile);
		...
		panelProfile.add(textFieldFirstNameProfile);
		...
		panelProfile.add(textFieldLastNameProfile);
		...
		final DefaultListModel md = new DefaultListModel();
